const zhHans = {
  ...
  version: {
    ...
    upToDate: '已是最新版本',
    automaticUnavailable: '此服务器尚未启用自动更新。',
    installUpdate: '立即更新',
    reload: '刷新页面',
    confirmTitle: '确认安装更新？',
  ...
  idcQuery: {
    ...
    readiness: {
      ...
      checks: {
        ...
        gateway_tls: '网关传输安全',
        gateway_auth: '网关服务令牌',
        idc_activity: 'IDC 操作活动',
      },
      details: {
        unavailable: '暂时无法获取状态。',
        enabled: '已有启用的 QQ 官方机器人运行。',
        not_configured: '缺少必要配置。',
        disabled: '该组件已停用。',
        ready: 'Webhook 事件通道已就绪。',
        websocket_mode: '机器人当前使用 WebSocket 模式，不经过回调地址。',
        conflict: '已启用的 Webhook 机器人存在 App ID 缺失或重复。',
        received: '已收到经过签名验证的 QQ 事件。',
        none: '尚未观测到实际活动。',
        connected: '运行时已响应健康检查。',
        disconnected: '运行时未响应健康检查。',
        not_loaded: 'IDC 查询插件尚未加载。',
        initialized: 'IDC 查询插件已成功初始化。',
        not_initialized: 'IDC 查询插件尚未进入初始化完成状态。',
        configured: '配置已存在。',
        invalid: '已保存的配置无效。',
        verified: '已启用 HTTPS 证书验证。',
        plaintext: '网关正在使用未加密的 HTTP。',
        verification_disabled: 'HTTPS 证书验证已关闭。',
        optional: '未配置服务令牌；仅当网关不要求令牌时可用。',
    ...
    seconds: '秒',
    protection: '防刷限制',
    requestsPerMinute: '每位成员每分钟查询上限',
    bindAttemptsPer10Minutes: '每位成员每 10 分钟绑定尝试上限',
    security: '安全',
    serviceToken: '服务令牌',
    tokenConfigured: '已配置',
    tokenNotConfigured: '未配置',
    tokenConfiguredPlaceholder: '留空则保留当前令牌',
    tokenPlaceholder: '输入服务令牌',
    clearToken: '清除令牌',
    keepToken: '保留令牌',
    tokenPendingClear: '保存后将清除当前服务令牌。',
    verifyTls: '验证 TLS 证书',
    tlsDisabled: 'TLS 证书验证已关闭。',
    save: '保存',
    saving: '保存中...',
    saveSuccess: 'IDC 查询配置已保存',
    ...
    connection: {
      test: '测试连接',
      testing: '测试中...',
      urlRequired: '请先填写网关地址',
      testError: '连接测试失败',
      notAvailable: '无',
      details: 'HTTP {{httpStatus}} · {{latency}} 毫秒 · TLS {{tls}}',
      authRejected: '网关拒绝了服务令牌。',
      authNotVerified: '网络连接正常；服务令牌将在实际业务请求中完成验证。',
      status: {
        reachable: '网关可以连接',
        authentication_failed: '网关鉴权失败',
        redirected: '网关地址返回了重定向',
        gateway_error: '网关返回了服务端错误',
        timeout: '连接网关超时',
        tls_error: 'TLS 证书验证失败',
        dns_error: '无法解析网关域名',
        connection_failed: '无法连接网关',
      },
      tls: {
        verified: '已验证',
        disabled: '已关闭验证',
    ...
    callback: {
      title: 'QQ 官方回调',
      refresh: '刷新回调状态',
      loading: '正在加载 QQ 回调状态...',
      loadError: '无法加载 QQ 回调状态',
      url: '回调地址',
      copy: '复制回调地址',
      copySuccess: '回调地址已复制',
      copyError: '无法复制回调地址',
      configuredUrl: '系统配置地址',
      configuredBots: '已配置 QQ 机器人',
      activeWebhooks: '运行中 Webhook',
      bots: 'QQ 机器人',
      empty: '尚未配置 QQ 官方机器人',
      unnamedBot: '未命名 QQ 机器人',
      appId: '应用 ID',
      enabled: '已启用',
      disabled: '已停用',
      lastEvent: '最近事件',
      ...
      status: {
        ...
        disabled: 'QQ 机器人未启用',
        websocket_mode: '当前使用 WebSocket',
        conflict: 'App ID 配置冲突',
      },
      mode: {
        webhook: 'Webhook',
        websocket: 'WebSocket',
    ...
    audit: {
      refresh: '刷新最近操作',
      loading: '正在加载最近操作...',
      loadError: '无法加载 IDC 最近操作',
      empty: '暂时没有 IDC 操作记录',
      generatedAt: '更新时间 {{time}} · 共 {{count}} 条',
      time: '时间',
      command: '指令',
      result: '结果',
      identity: 'QQ 身份',
      ...
      reasons: {
        ...
        queried: '查询完成',
        not_bound: '群尚未绑定',
        binder_required: '仅绑定人可操作',
        already_bound: '已经绑定',
        binding_conflict: '已绑定其他会员',
        rate_limit: '达到频率上限',
        gateway_error: '网关请求失败',
        internal_error: '处理失败',
      },
    },
  },
