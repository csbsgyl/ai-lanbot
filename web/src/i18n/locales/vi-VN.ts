const viVN = {
  ...
  version: {
    ...
    updateCenter: 'Cập nhật phần mềm',
    manageUpdates: 'Quản lý cập nhật',
    currentRevision: 'Bản sửa đổi hiện tại',
    latestRevision: 'Bản sửa đổi mới nhất',
    updateStatus: 'Trạng thái',
    checkForUpdates: 'Kiểm tra cập nhật',
    checking: 'Đang kiểm tra...',
    statusUnknown: 'Không xác định',
    queued: 'Đã xếp hàng cập nhật',
    deploying: 'Đang cài đặt bản cập nhật...',
    ...
    automaticUnavailable: 'Cập nhật tự động chưa được bật trên máy chủ này.',
    installUpdate: 'Cập nhật ngay',
    reload: 'Tải lại',
    confirmTitle: 'Cài đặt bản cập nhật?',
    confirmDescription:
      'Dịch vụ sẽ khởi động lại và bảng điều khiển sẽ tạm thời không khả dụng.',
    updateQueued: 'Đã gửi yêu cầu cập nhật',
  },
  account: {
  ...
  idcQuery: {
    ...
    readiness: {
      ...
      refresh: 'Làm mới mức sẵn sàng',
      loading: 'Đang kiểm tra mức sẵn sàng vận hành...',
      loadError: 'Không thể tải mức sẵn sàng vận hành',
      generatedAt: 'Thời điểm kiểm tra',
      lastQQEvent: 'Sự kiện QQ gần nhất',
      lastIDCOperation: 'Thao tác IDC gần nhất',
      never: 'Chưa ghi nhận',
      overall: {
        ready: 'Sẵn sàng',
        attention: 'Cần chú ý',
      ...
      checks: {
        qq_bot: 'Bot QQ chính thức',
        qq_callback: 'Kênh sự kiện QQ',
        qq_activity: 'Hoạt động sự kiện QQ',
        plugin_runtime: 'Môi trường chạy plugin',
        idc_plugin: 'Plugin truy vấn IDC',
        gateway_config: 'Cổng truy vấn',
        gateway_tls: 'Bảo mật truyền tải của cổng',
        gateway_auth: 'Token dịch vụ của cổng',
        idc_activity: 'Hoạt động thao tác IDC',
      },
      details: {
        unavailable: 'Tạm thời không thể lấy trạng thái.',
        enabled: 'Một bot QQ chính thức đã bật đang hoạt động.',
        not_configured: 'Thiếu cấu hình bắt buộc.',
        disabled: 'Thành phần đã bị tắt.',
        ready: 'Kênh sự kiện Webhook đã sẵn sàng.',
        websocket_mode: 'Bot đang dùng WebSocket thay cho địa chỉ callback.',
        conflict: 'Các bot Webhook đang bật có App ID bị thiếu hoặc trùng.',
        received: 'Đã nhận một sự kiện QQ có chữ ký hợp lệ.',
        none: 'Chưa ghi nhận hoạt động thực tế.',
        connected: 'Môi trường chạy đã phản hồi kiểm tra sức khỏe.',
        disconnected: 'Môi trường chạy không phản hồi kiểm tra sức khỏe.',
        not_loaded: 'Plugin truy vấn IDC chưa được tải.',
        initialized: 'Plugin truy vấn IDC đã khởi tạo thành công.',
        not_initialized: 'Plugin truy vấn IDC chưa hoàn tất khởi tạo.',
        configured: 'Đã có cấu hình.',
        invalid: 'Cấu hình đã lưu không hợp lệ.',
        verified: 'Đã bật xác minh chứng chỉ HTTPS.',
        plaintext: 'Cổng đang dùng HTTP không mã hóa.',
        verification_disabled: 'Đã tắt xác minh chứng chỉ HTTPS.',
        optional:
          'Chưa đặt token dịch vụ; chỉ hợp lệ khi cổng không yêu cầu token.',
    ...
    refresh: 'Làm mới',
    loading: 'Đang tải...',
    loadError: 'Không thể tải cài đặt truy vấn IDC',
    retry: 'Thử lại',
    gateway: 'Cổng truy vấn',
    gatewayUrl: 'URL cổng truy vấn',
    gatewayUrlPlaceholder: 'https://query.example.com',
    timeout: 'Thời gian chờ yêu cầu',
    seconds: 'giây',
    protection: 'Chống lạm dụng',
    requestsPerMinute: 'Truy vấn mỗi thành viên / phút',
    bindAttemptsPer10Minutes: 'Lần liên kết mỗi thành viên / 10 phút',
    security: 'Bảo mật',
    serviceToken: 'Mã thông báo dịch vụ',
    tokenConfigured: 'Đã cấu hình',
    tokenNotConfigured: 'Chưa cấu hình',
    tokenConfiguredPlaceholder: 'Để trống để giữ mã thông báo hiện tại',
    tokenPlaceholder: 'Nhập mã thông báo dịch vụ',
    clearToken: 'Xóa mã thông báo',
    keepToken: 'Giữ mã thông báo',
    tokenPendingClear: 'Mã thông báo dịch vụ hiện tại sẽ bị xóa khi lưu.',
    verifyTls: 'Xác minh chứng chỉ TLS',
    tlsDisabled: 'Đã tắt xác minh chứng chỉ TLS.',
    save: 'Lưu',
    saving: 'Đang lưu...',
    saveSuccess: 'Đã lưu cài đặt truy vấn IDC',
    ...
    callback: {
      ...
      refresh: 'Làm mới trạng thái callback',
      loading: 'Đang tải trạng thái callback QQ...',
      loadError: 'Không thể tải trạng thái callback QQ',
      url: 'URL callback',
      copy: 'Sao chép URL callback',
      copySuccess: 'Đã sao chép URL callback',
      copyError: 'Không thể sao chép URL callback',
      configuredUrl: 'URL công khai đã cấu hình',
      configuredBots: 'Bot QQ đã cấu hình',
      activeWebhooks: 'Webhook đang hoạt động',
      bots: 'Bot QQ',
      empty: 'Chưa cấu hình bot QQ Official',
      unnamedBot: 'Bot QQ chưa đặt tên',
      appId: 'ID ứng dụng',
      enabled: 'Đã bật',
      disabled: 'Đã tắt',
      ...
      status: {
        ...
        disabled: 'Bot QQ đã tắt',
        websocket_mode: 'Chế độ WebSocket',
        conflict: 'Xung đột App ID',
      },
      mode: {
        webhook: 'Webhook',
        websocket: 'WebSocket',
    ...
    audit: {
      ...
      loadError: 'Không thể tải hoạt động IDC gần đây',
      empty: 'Chưa ghi nhận thao tác IDC nào',
      generatedAt: 'Cập nhật {{time}} · {{count}} bản ghi',
      time: 'Thời gian',
      command: 'Lệnh',
      result: 'Kết quả',
      identity: 'Danh tính QQ',
      member: 'Thành viên',
      duration: 'Thời lượng',
      groupShort: 'Nhóm',
      ...
      reasons: {
        bound: 'Đã tạo liên kết',
        unbound: 'Đã xóa liên kết',
        queried: 'Truy vấn hoàn tất',
        not_bound: 'Nhóm chưa liên kết',
        binder_required: 'Cần quyền của người liên kết',
        already_bound: 'Đã liên kết',
        binding_conflict: 'Đã liên kết thành viên khác',
        rate_limit: 'Đã đạt giới hạn yêu cầu',
        gateway_error: 'Yêu cầu cổng thất bại',
        internal_error: 'Xử lý thất bại',
      },
    },
  },
  storageAnalysis: {
