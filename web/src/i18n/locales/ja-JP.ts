const jaJP = {
  ...
  version: {
    ...
    updateCenter: 'ソフトウェア更新',
    manageUpdates: '更新を管理',
    currentRevision: '現在のリビジョン',
    latestRevision: '最新のリビジョン',
    updateStatus: '状態',
    checkForUpdates: '更新を確認',
    checking: '確認中...',
    statusUnknown: '状態不明',
    queued: '更新待機中',
    deploying: '更新をインストール中...',
    ...
    upToDate: '最新です',
    automaticUnavailable: 'このサーバーでは自動更新が有効になっていません。',
    installUpdate: '今すぐ更新',
    reload: '再読み込み',
    confirmTitle: '更新をインストールしますか？',
    confirmDescription:
      '既定ではローカルデータをバックアップしてからサービスを再起動するため、ダッシュボードに一時的に接続できなくなります。',
    updateQueued: '更新リクエストを送信しました',
  },
  account: {
    settings: 'アカウント設定',
  ...
  idcQuery: {
    ...
    readiness: {
      title: '本番稼働チェック',
      refresh: '稼働状態を更新',
      loading: '本番稼働状態を確認しています...',
      loadError: '本番稼働状態を読み込めませんでした',
      generatedAt: '確認日時',
      lastQQEvent: '最新の QQ イベント',
      lastIDCOperation: '最新の IDC 操作',
      never: 'まだ観測されていません',
      overall: {
        ready: '準備完了',
        attention: '要確認',
      ...
      checks: {
        qq_bot: 'QQ 公式ボット',
        qq_callback: 'QQ イベント経路',
        qq_activity: 'QQ イベント実績',
        plugin_runtime: 'プラグインランタイム',
        idc_plugin: 'IDC クエリプラグイン',
        gateway_config: 'クエリゲートウェイ',
        gateway_tls: 'ゲートウェイ通信セキュリティ',
        gateway_auth: 'ゲートウェイサービストークン',
        idc_activity: 'IDC 操作実績',
      },
      details: {
        unavailable: '状態を一時的に取得できません。',
        enabled: '有効な QQ 公式ボットが稼働しています。',
        not_configured: '必要な設定がありません。',
        disabled: 'コンポーネントは無効です。',
        ready: 'Webhook イベント経路は準備完了です。',
        websocket_mode:
          'ボットはコールバックではなく WebSocket モードを使用しています。',
        conflict:
          '有効な Webhook ボットの App ID が未設定または重複しています。',
        received: '署名検証済みの QQ イベントを受信しました。',
        none: '実際の動作はまだ観測されていません。',
        connected: 'ランタイムはヘルスチェックに応答しました。',
        disconnected: 'ランタイムはヘルスチェックに応答しませんでした。',
        not_loaded: 'IDC クエリプラグインが読み込まれていません。',
        initialized: 'IDC クエリプラグインは正常に初期化されました。',
        not_initialized: 'IDC クエリプラグインの初期化が完了していません。',
        configured: '設定があります。',
        invalid: '保存された設定が無効です。',
        verified: 'HTTPS 証明書の検証が有効です。',
        plaintext: 'ゲートウェイは暗号化されていない HTTP を使用しています。',
        verification_disabled: 'HTTPS 証明書の検証が無効です。',
        optional:
          'サービストークンは未設定です。ゲートウェイが不要とする場合のみ有効です。',
    ...
    refresh: '更新',
    loading: '読み込み中...',
    loadError: 'IDC クエリ設定を読み込めませんでした',
    retry: '再試行',
    gateway: 'ゲートウェイ',
    ...
    seconds: '秒',
    protection: '不正利用防止',
    requestsPerMinute: 'メンバーごとの1分あたりクエリ上限',
    bindAttemptsPer10Minutes: 'メンバーごとの10分あたりバインド試行上限',
    security: 'セキュリティ',
    serviceToken: 'サービストークン',
    tokenConfigured: '設定済み',
    tokenNotConfigured: '未設定',
    tokenConfiguredPlaceholder: '空欄のままにすると現在のトークンを保持します',
    tokenPlaceholder: 'サービストークンを入力',
    clearToken: 'トークンを消去',
    keepToken: 'トークンを保持',
    tokenPendingClear: '保存すると現在のサービストークンが消去されます。',
    verifyTls: 'TLS 証明書を検証',
    tlsDisabled: 'TLS 証明書の検証が無効です。',
    save: '保存',
    saving: '保存中...',
    saveSuccess: 'IDC クエリ設定を保存しました',
    ...
    callback: {
      title: 'QQ 公式コールバック',
      refresh: 'コールバック状態を更新',
      loading: 'QQ コールバック状態を読み込み中...',
      loadError: 'QQ コールバック状態を読み込めませんでした',
      url: 'コールバック URL',
      copy: 'コールバック URL をコピー',
      copySuccess: 'コールバック URL をコピーしました',
      copyError: 'コールバック URL をコピーできませんでした',
      configuredUrl: '設定済み公開 URL',
      configuredBots: '設定済み QQ ボット',
      activeWebhooks: '有効な Webhook',
      bots: 'QQ ボット',
      empty: 'QQ 公式ボットが設定されていません',
      unnamedBot: '名称未設定の QQ ボット',
      appId: 'アプリ ID',
      enabled: '有効',
      disabled: '無効',
      lastEvent: '最終イベント',
    ...
    audit: {
      refresh: '最近の操作を更新',
      loading: '最近の操作を読み込み中...',
      loadError: 'IDC の最近の操作を読み込めませんでした',
      empty: 'IDC 操作はまだ記録されていません',
      generatedAt: '更新 {{time}} · {{count}} 件',
      time: '時刻',
      command: 'コマンド',
      result: '結果',
      identity: 'QQ ID',
      ...
      reasons: {
        ...
        queried: 'クエリ完了',
        not_bound: 'グループ未バインド',
        binder_required: 'バインド実行者の権限が必要',
        already_bound: 'バインド済み',
        binding_conflict: '別の会員にバインド済み',
        rate_limit: '頻度上限に到達',
        gateway_error: 'ゲートウェイ要求失敗',
        internal_error: '処理失敗',
      },
    },
  },
