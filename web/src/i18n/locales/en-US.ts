const enUS = {
  ...
  version: {
    ...
    upToDate: 'Up to date',
    automaticUnavailable: 'Automatic updates are not enabled on this server.',
  ...
  idcQuery: {
    ...
    readiness: {
      ...
      loading: 'Checking production readiness...',
      loadError: 'Failed to load production readiness',
      generatedAt: 'Checked at',
      lastQQEvent: 'Last QQ event',
      lastIDCOperation: 'Last IDC operation',
      ...
      checks: {
        qq_bot: 'QQ Official bot',
        qq_callback: 'QQ event transport',
        qq_activity: 'QQ event activity',
        plugin_runtime: 'Plugin Runtime',
        idc_plugin: 'IDC query plugin',
        gateway_config: 'Query gateway',
        gateway_tls: 'Gateway transport security',
        gateway_auth: 'Gateway service token',
        idc_activity: 'IDC operation activity',
      },
      details: {
        unavailable: 'Status is temporarily unavailable.',
        enabled: 'An enabled QQ Official bot is running.',
        not_configured: 'Required configuration is missing.',
        disabled: 'The component is disabled.',
        ready: 'Webhook event transport is ready.',
        websocket_mode:
          'The bot is using WebSocket mode instead of the callback.',
        conflict: 'Enabled webhook bots have missing or duplicate App IDs.',
        received: 'A signed QQ event has been received.',
        none: 'No activity has been observed yet.',
        connected: 'The runtime responded to its health check.',
        disconnected: 'The runtime did not respond to its health check.',
        not_loaded: 'The IDC query plugin is not loaded.',
        initialized: 'The IDC query plugin initialized successfully.',
        not_initialized:
          'The IDC query plugin has not reached the initialized state.',
        configured: 'Configuration is present.',
        invalid: 'The saved configuration is invalid.',
        verified: 'HTTPS certificate verification is enabled.',
        plaintext: 'The gateway uses unencrypted HTTP.',
        verification_disabled: 'HTTPS certificate verification is disabled.',
        optional:
          'No service token is set; this is valid only when the gateway does not require one.',
    ...
    refresh: 'Refresh',
    loading: 'Loading...',
    loadError: 'Failed to load IDC query settings',
    retry: 'Retry',
    gateway: 'Gateway',
    ...
    requestsPerMinute: 'Queries per member / minute',
    bindAttemptsPer10Minutes: 'Binding attempts per member / 10 minutes',
    security: 'Security',
    serviceToken: 'Service token',
    tokenConfigured: 'Configured',
    tokenNotConfigured: 'Not configured',
    tokenConfiguredPlaceholder: 'Leave blank to keep the current token',
    tokenPlaceholder: 'Enter a service token',
    clearToken: 'Clear token',
    keepToken: 'Keep token',
    tokenPendingClear: 'The current service token will be cleared on save.',
    verifyTls: 'Verify TLS certificate',
    tlsDisabled: 'TLS certificate verification is disabled.',
    save: 'Save',
    saving: 'Saving...',
    saveSuccess: 'IDC query settings saved',
    ...
    callback: {
      title: 'QQ Official callback',
      refresh: 'Refresh callback status',
      loading: 'Loading QQ callback status...',
      loadError: 'Failed to load QQ callback status',
      url: 'Callback URL',
      copy: 'Copy callback URL',
      copySuccess: 'Callback URL copied',
      copyError: 'Could not copy callback URL',
      configuredUrl: 'Configured public URL',
      configuredBots: 'Configured QQ bots',
      activeWebhooks: 'Active webhooks',
      bots: 'QQ bots',
      empty: 'No QQ Official bots are configured',
      unnamedBot: 'Unnamed QQ bot',
      appId: 'App ID',
      enabled: 'Enabled',
      disabled: 'Disabled',
      ...
      status: {
        ...
        disabled: 'QQ bot disabled',
        websocket_mode: 'WebSocket mode',
        conflict: 'App ID conflict',
      },
      mode: {
        webhook: 'Webhook',
        websocket: 'WebSocket',
    ...
    audit: {
      ...
      loadError: 'Failed to load recent IDC activity',
      empty: 'No IDC operations recorded yet',
      generatedAt: 'Updated {{time}} · {{count}} records',
      time: 'Time',
      command: 'Command',
      result: 'Result',
      identity: 'QQ identity',
      member: 'Member',
      duration: 'Duration',
      groupShort: 'Group',
      userShort: 'User',
      ...
      reasons: {
        bound: 'Binding created',
        unbound: 'Binding removed',
        queried: 'Query completed',
        not_bound: 'Group is not bound',
        binder_required: 'Binder permission required',
        already_bound: 'Already bound',
        binding_conflict: 'Different member is bound',
