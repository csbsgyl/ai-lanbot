const thTH = {
  ...
  version: {
    ...
    updateCenter: 'อัปเดตซอฟต์แวร์',
    manageUpdates: 'จัดการการอัปเดต',
    currentRevision: 'รุ่นปัจจุบัน',
    latestRevision: 'รุ่นล่าสุด',
    updateStatus: 'สถานะ',
    checkForUpdates: 'ตรวจสอบการอัปเดต',
    checking: 'กำลังตรวจสอบ...',
    statusUnknown: 'ไม่ทราบสถานะ',
    queued: 'อยู่ในคิวอัปเดต',
    deploying: 'กำลังติดตั้งอัปเดต...',
    restarting: 'กำลังเริ่มบริการใหม่...',
    updateFailed: 'อัปเดตล้มเหลว',
    updateSuccess: 'อัปเดตเสร็จสิ้น',
    checkFailed: 'ไม่สามารถตรวจสอบการอัปเดต',
    updateAvailable: 'มีอัปเดตใหม่',
    upToDate: 'เป็นเวอร์ชันล่าสุด',
    automaticUnavailable: 'เซิร์ฟเวอร์นี้ไม่ได้เปิดใช้การอัปเดตอัตโนมัติ',
    installUpdate: 'อัปเดตตอนนี้',
    reload: 'โหลดใหม่',
    confirmTitle: 'ติดตั้งอัปเดตหรือไม่?',
    confirmDescription: 'บริการจะเริ่มใหม่และแดชบอร์ดจะใช้งานไม่ได้ชั่วคราว',
    updateQueued: 'ส่งคำขออัปเดตแล้ว',
  },
  account: {
  ...
  idcQuery: {
    title: 'การค้นหา IDC',
    description: 'กำหนดค่าเกตเวย์ค้นหาข้อมูลลูกค้าที่มีการยืนยันตัวตน',
    tabs: {
      readiness: 'ภาพรวม',
      configuration: 'การกำหนดค่า',
      callback: 'คอลแบ็ก QQ',
      bindings: 'กลุ่มที่ผูกบัญชี',
      audit: 'กิจกรรมล่าสุด',
    },
    readiness: {
      title: 'ความพร้อมใช้งานจริง',
      refresh: 'รีเฟรชความพร้อม',
      loading: 'กำลังตรวจสอบความพร้อมใช้งานจริง...',
      loadError: 'โหลดสถานะความพร้อมใช้งานจริงไม่สำเร็จ',
      generatedAt: 'เวลาที่ตรวจสอบ',
      lastQQEvent: 'เหตุการณ์ QQ ล่าสุด',
      lastIDCOperation: 'การดำเนินการ IDC ล่าสุด',
      never: 'ยังไม่พบ',
      overall: {
        ready: 'พร้อมใช้งาน',
      ...
      checks: {
        qq_bot: 'บอต QQ อย่างเป็นทางการ',
        qq_callback: 'ช่องทางเหตุการณ์ QQ',
        qq_activity: 'กิจกรรมเหตุการณ์ QQ',
        plugin_runtime: 'รันไทม์ปลั๊กอิน',
        idc_plugin: 'ปลั๊กอินค้นหา IDC',
        gateway_config: 'เกตเวย์ค้นหา',
        gateway_tls: 'ความปลอดภัยการรับส่งของเกตเวย์',
        gateway_auth: 'โทเค็นบริการของเกตเวย์',
        idc_activity: 'กิจกรรมการดำเนินการ IDC',
      },
      details: {
        unavailable: 'ไม่สามารถอ่านสถานะได้ชั่วคราว',
        enabled: 'บอต QQ อย่างเป็นทางการที่เปิดใช้งานกำลังทำงาน',
        not_configured: 'ขาดการกำหนดค่าที่จำเป็น',
        disabled: 'ส่วนประกอบถูกปิดใช้งาน',
        ready: 'ช่องทางเหตุการณ์ Webhook พร้อมใช้งาน',
        websocket_mode: 'บอตใช้โหมด WebSocket แทนที่อยู่คอลแบ็ก',
        conflict: 'บอต Webhook ที่เปิดใช้งานมี App ID หายไปหรือซ้ำกัน',
        received: 'ได้รับเหตุการณ์ QQ ที่ตรวจสอบลายเซ็นแล้ว',
        none: 'ยังไม่พบกิจกรรมจริง',
        connected: 'รันไทม์ตอบสนองต่อการตรวจสอบสุขภาพ',
        disconnected: 'รันไทม์ไม่ตอบสนองต่อการตรวจสอบสุขภาพ',
        not_loaded: 'ยังไม่ได้โหลดปลั๊กอินค้นหา IDC',
        initialized: 'ปลั๊กอินค้นหา IDC เริ่มต้นสำเร็จ',
        not_initialized: 'ปลั๊กอินค้นหา IDC ยังเริ่มต้นไม่เสร็จ',
        configured: 'มีการกำหนดค่าแล้ว',
        invalid: 'การกำหนดค่าที่บันทึกไว้ไม่ถูกต้อง',
        verified: 'เปิดการตรวจสอบใบรับรอง HTTPS แล้ว',
        plaintext: 'เกตเวย์ใช้ HTTP ที่ไม่ได้เข้ารหัส',
        verification_disabled: 'ปิดการตรวจสอบใบรับรอง HTTPS แล้ว',
        optional:
          'ไม่ได้ตั้งโทเค็นบริการ ใช้ได้เฉพาะเมื่อเกตเวย์ไม่ต้องการโทเค็น',
        recorded: 'มีการบันทึกการดำเนินการ IDC แล้ว',
      },
    },
    diagnostics: {
      copy: 'คัดลอกรายงานวินิจฉัย',
      copied: 'คัดลอกรายงานวินิจฉัยแล้ว',
      copyError: 'ไม่สามารถคัดลอกรายงานวินิจฉัยได้',
    },
    configured: 'กำหนดค่าเกตเวย์แล้ว',
    notConfigured: 'ยังไม่ได้กำหนดค่าเกตเวย์',
    refresh: 'รีเฟรช',
    loading: 'กำลังโหลด...',
    loadError: 'โหลดการตั้งค่าการค้นหา IDC ไม่สำเร็จ',
    retry: 'ลองอีกครั้ง',
    gateway: 'เกตเวย์',
    gatewayUrl: 'URL เกตเวย์',
    gatewayUrlPlaceholder: 'https://query.example.com',
    timeout: 'เวลาหมดอายุของคำขอ',
    seconds: 'วินาที',
    protection: 'การป้องกันการใช้งานเกินกำหนด',
    requestsPerMinute: 'จำนวนคำขอต่อสมาชิก / นาที',
    bindAttemptsPer10Minutes: 'จำนวนครั้งผูกบัญชีต่อสมาชิก / 10 นาที',
    security: 'ความปลอดภัย',
    serviceToken: 'โทเค็นบริการ',
    tokenConfigured: 'กำหนดค่าแล้ว',
    tokenNotConfigured: 'ยังไม่ได้กำหนดค่า',
    tokenConfiguredPlaceholder: 'เว้นว่างเพื่อเก็บโทเค็นปัจจุบันไว้',
    tokenPlaceholder: 'ป้อนโทเค็นบริการ',
    clearToken: 'ล้างโทเค็น',
    keepToken: 'เก็บโทเค็น',
    tokenPendingClear: 'โทเค็นบริการปัจจุบันจะถูกล้างเมื่อบันทึก',
    verifyTls: 'ตรวจสอบใบรับรอง TLS',
    tlsDisabled: 'ปิดการตรวจสอบใบรับรอง TLS อยู่',
    save: 'บันทึก',
    saving: 'กำลังบันทึก...',
    saveSuccess: 'บันทึกการตั้งค่าการค้นหา IDC แล้ว',
    ...
    callback: {
      title: 'คอลแบ็ก QQ Official',
      refresh: 'รีเฟรชสถานะคอลแบ็ก',
      loading: 'กำลังโหลดสถานะคอลแบ็ก QQ...',
      loadError: 'โหลดสถานะคอลแบ็ก QQ ไม่สำเร็จ',
      url: 'URL คอลแบ็ก',
      copy: 'คัดลอก URL คอลแบ็ก',
      copySuccess: 'คัดลอก URL คอลแบ็กแล้ว',
      copyError: 'ไม่สามารถคัดลอก URL คอลแบ็กได้',
      configuredUrl: 'URL สาธารณะที่กำหนดค่า',
      configuredBots: 'บอต QQ ที่กำหนดค่า',
      activeWebhooks: 'Webhook ที่ใช้งาน',
      bots: 'บอต QQ',
      empty: 'ยังไม่ได้กำหนดค่าบอต QQ Official',
      unnamedBot: 'บอต QQ ที่ไม่มีชื่อ',
      appId: 'App ID',
      enabled: 'เปิดใช้งาน',
      disabled: 'ปิดใช้งาน',
      ...
      status: {
        ...
        disabled: 'บอต QQ ถูกปิดใช้งาน',
        websocket_mode: 'โหมด WebSocket',
        conflict: 'App ID ขัดแย้งกัน',
      },
      mode: {
        webhook: 'Webhook',
        websocket: 'WebSocket',
    ...
    bindings: {
      ...
      loadError: 'โหลดกลุ่มที่ผูกบัญชี IDC ไม่สำเร็จ',
      empty: 'ยังไม่มีกลุ่มที่ผูกบัญชี',
      generatedAt: 'อัปเดต {{time}} · แสดง {{count}} จาก {{total}} รายการ',
      boundAt: 'เวลาที่ผูก',
      customer: 'ลูกค้า',
      group: 'กลุ่ม QQ',
      boundBy: 'ผู้ผูกบัญชี',
      unnamed: 'สมาชิกไม่มีชื่อ',
    },
    audit: {
      refresh: 'รีเฟรชกิจกรรม',
      loading: 'กำลังโหลดกิจกรรมล่าสุด...',
      loadError: 'โหลดกิจกรรม IDC ล่าสุดไม่สำเร็จ',
      empty: 'ยังไม่มีการบันทึกการดำเนินการ IDC',
      generatedAt: 'อัปเดต {{time}} · {{count}} รายการ',
      time: 'เวลา',
      command: 'คำสั่ง',
      result: 'ผลลัพธ์',
      identity: 'ข้อมูลระบุตัวตน QQ',
      member: 'สมาชิก',
      duration: 'ระยะเวลา',
      groupShort: 'กลุ่ม',
      userShort: 'ผู้ใช้',
      ...
      outcomes: {
        ...
        gateway_error: 'ข้อผิดพลาดเกตเวย์',
        internal_error: 'ข้อผิดพลาดภายใน',
      },
      reasons: {
        bound: 'สร้างการผูกบัญชีแล้ว',
        unbound: 'ยกเลิกการผูกแล้ว',
        queried: 'ค้นหาสำเร็จ',
        not_bound: 'กลุ่มยังไม่ผูกบัญชี',
        binder_required: 'ต้องใช้สิทธิ์ผู้ผูกบัญชี',
        already_bound: 'ผูกบัญชีแล้ว',
        binding_conflict: 'ผูกกับสมาชิกรายอื่นแล้ว',
        rate_limit: 'ถึงขีดจำกัดคำขอ',
        gateway_error: 'คำขอเกตเวย์ล้มเหลว',
        internal_error: 'การประมวลผลล้มเหลว',
      },
    },
  },
  storageAnalysis: {
