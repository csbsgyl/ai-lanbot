const zhHant = {
  ...
  version: {
    ...
    upToDate: '已是最新版本',
    automaticUnavailable: '此伺服器尚未啟用自動更新。',
    installUpdate: '立即更新',
    reload: '重新整理頁面',
    confirmTitle: '確認安裝更新？',
    confirmDescription: '更新期間服務將重新啟動，後台會短暫中斷連線。',
    updateQueued: '更新請求已提交',
  },
  account: {
    settings: '帳戶設定',
  ...
  idcQuery: {
    ...
    readiness: {
      ...
      refresh: '重新整理就緒狀態',
      loading: '正在檢查生產就緒狀態...',
      loadError: '無法載入生產就緒狀態',
      generatedAt: '檢查時間',
      lastQQEvent: '最近 QQ 事件',
      lastIDCOperation: '最近 IDC 操作',
      never: '尚未觀測到',
      overall: {
        ready: '已就緒',
        attention: '需要關注',
      ...
      checks: {
        ...
        qq_callback: 'QQ 事件通道',
        qq_activity: 'QQ 事件活動',
        plugin_runtime: '外掛執行階段',
        idc_plugin: 'IDC 查詢外掛',
        gateway_config: '查詢閘道',
        gateway_tls: '閘道傳輸安全',
        gateway_auth: '閘道服務權杖',
        idc_activity: 'IDC 操作活動',
      },
      details: {
        unavailable: '暫時無法取得狀態。',
        enabled: '已有啟用的 QQ 官方機器人執行。',
        not_configured: '缺少必要設定。',
        disabled: '此元件已停用。',
        ready: 'Webhook 事件通道已就緒。',
        websocket_mode: '機器人目前使用 WebSocket 模式，不經過回調位址。',
        conflict: '已啟用的 Webhook 機器人存在 App ID 缺失或重複。',
        received: '已收到通過簽章驗證的 QQ 事件。',
        none: '尚未觀測到實際活動。',
        connected: '執行階段已回應健康檢查。',
        disconnected: '執行階段未回應健康檢查。',
        not_loaded: 'IDC 查詢外掛尚未載入。',
        initialized: 'IDC 查詢外掛已成功初始化。',
        not_initialized: 'IDC 查詢外掛尚未完成初始化。',
        configured: '設定已存在。',
        invalid: '已儲存的設定無效。',
        verified: '已啟用 HTTPS 憑證驗證。',
        plaintext: '閘道正在使用未加密的 HTTP。',
        verification_disabled: 'HTTPS 憑證驗證已關閉。',
        optional: '未設定服務權杖；僅在閘道不要求權杖時可用。',
    ...
    seconds: '秒',
    protection: '防刷限制',
    requestsPerMinute: '每位成員每分鐘查詢上限',
    bindAttemptsPer10Minutes: '每位成員每 10 分鐘綁定嘗試上限',
    security: '安全性',
    serviceToken: '服務權杖',
    tokenConfigured: '已設定',
    tokenNotConfigured: '未設定',
    tokenConfiguredPlaceholder: '留空則保留目前權杖',
    tokenPlaceholder: '輸入服務權杖',
    clearToken: '清除權杖',
    keepToken: '保留權杖',
    tokenPendingClear: '儲存後將清除目前服務權杖。',
    verifyTls: '驗證 TLS 憑證',
    tlsDisabled: 'TLS 憑證驗證已關閉。',
    save: '儲存',
    saving: '儲存中...',
    saveSuccess: 'IDC 查詢設定已儲存',
    ...
    connection: {
      test: '測試連線',
      testing: '測試中...',
      urlRequired: '請先填寫閘道位址',
      testError: '連線測試失敗',
      notAvailable: '無',
      details: 'HTTP {{httpStatus}} · {{latency}} 毫秒 · TLS {{tls}}',
      authRejected: '閘道拒絕了服務權杖。',
      authNotVerified: '網路連線正常；服務權杖將在實際業務請求中完成驗證。',
      status: {
        reachable: '閘道可以連線',
        authentication_failed: '閘道驗證失敗',
        redirected: '閘道位址回傳重新導向',
        gateway_error: '閘道回傳伺服器錯誤',
        timeout: '連線閘道逾時',
        tls_error: 'TLS 憑證驗證失敗',
        dns_error: '無法解析閘道網域名稱',
        connection_failed: '無法連線閘道',
      },
      tls: {
        verified: '已驗證',
        disabled: '已關閉驗證',
    ...
    callback: {
      title: 'QQ 官方回調',
      refresh: '重新整理回調狀態',
      loading: '正在載入 QQ 回調狀態...',
      loadError: '無法載入 QQ 回調狀態',
      url: '回調位址',
      copy: '複製回調位址',
      copySuccess: '回調位址已複製',
      copyError: '無法複製回調位址',
      configuredUrl: '系統設定位址',
      configuredBots: '已設定 QQ 機器人',
      activeWebhooks: '運行中 Webhook',
      bots: 'QQ 機器人',
      empty: '尚未設定 QQ 官方機器人',
      unnamedBot: '未命名 QQ 機器人',
      appId: '應用程式 ID',
      enabled: '已啟用',
      disabled: '已停用',
      lastEvent: '最近事件',
      ...
      status: {
        ...
        disabled: 'QQ 機器人未啟用',
        websocket_mode: '目前使用 WebSocket',
        conflict: 'App ID 設定衝突',
      },
      mode: {
        webhook: 'Webhook',
        websocket: 'WebSocket',
    ...
    audit: {
      refresh: '重新整理最近操作',
      loading: '正在載入最近操作...',
      loadError: '無法載入 IDC 最近操作',
      empty: '暫時沒有 IDC 操作記錄',
      generatedAt: '更新時間 {{time}} · 共 {{count}} 筆',
      time: '時間',
      command: '指令',
      result: '結果',
      identity: 'QQ 身分',
      ...
      reasons: {
        ...
        queried: '查詢完成',
        not_bound: '群尚未綁定',
        binder_required: '僅綁定人可操作',
        already_bound: '已經綁定',
        binding_conflict: '已綁定其他會員',
        rate_limit: '達到頻率上限',
        gateway_error: '閘道請求失敗',
        internal_error: '處理失敗',
      },
    },
  },
