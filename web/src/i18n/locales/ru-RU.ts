const ruRU = {
  ...
  version: {
    ...
    updateCenter: 'Обновление ПО',
    manageUpdates: 'Управление обновлениями',
    ...
    deploying: 'Установка обновления...',
    ...
    automaticUnavailable:
      'Автоматические обновления не включены на этом сервере.',
    installUpdate: 'Обновить сейчас',
    reload: 'Перезагрузить',
    confirmTitle: 'Установить обновление?',
    confirmDescription:
      'Сервис перезапустится, и панель будет временно недоступна.',
    updateQueued: 'Запрос на обновление отправлен',
  },
  account: {
  ...
  idcQuery: {
    title: 'IDC-запросы',
    description: 'Настройка шлюза клиентских запросов с аутентификацией',
    tabs: {
      readiness: 'Обзор',
      configuration: 'Настройка',
      callback: 'Callback QQ',
      bindings: 'Привязки групп',
      audit: 'Недавние операции',
    },
    readiness: {
      title: 'Готовность к работе',
      refresh: 'Обновить готовность',
      loading: 'Проверка готовности к работе...',
      loadError: 'Не удалось загрузить состояние готовности',
      generatedAt: 'Проверено',
      lastQQEvent: 'Последнее событие QQ',
      lastIDCOperation: 'Последняя операция IDC',
      never: 'Пока не наблюдалось',
      overall: {
        ready: 'Готово',
      ...
      checks: {
        qq_bot: 'Официальный бот QQ',
        qq_callback: 'Канал событий QQ',
        qq_activity: 'Активность событий QQ',
        plugin_runtime: 'Среда выполнения плагинов',
        idc_plugin: 'Плагин IDC-запросов',
        gateway_config: 'Шлюз запросов',
        gateway_tls: 'Защита соединения со шлюзом',
        gateway_auth: 'Сервисный токен шлюза',
        idc_activity: 'Активность операций IDC',
      },
      details: {
        unavailable: 'Состояние временно недоступно.',
        enabled: 'Включенный официальный бот QQ работает.',
        not_configured: 'Отсутствует обязательная настройка.',
        disabled: 'Компонент отключен.',
        ready: 'Канал событий Webhook готов.',
        websocket_mode: 'Бот использует WebSocket вместо callback-адреса.',
        conflict:
          'У включенных Webhook-ботов отсутствуют или повторяются App ID.',
        received: 'Получено событие QQ с проверенной подписью.',
        none: 'Фактическая активность пока не наблюдалась.',
        connected: 'Среда выполнения ответила на проверку состояния.',
        disconnected: 'Среда выполнения не ответила на проверку состояния.',
        not_loaded: 'Плагин IDC-запросов не загружен.',
        initialized: 'Плагин IDC-запросов успешно инициализирован.',
        not_initialized: 'Плагин IDC-запросов еще не завершил инициализацию.',
        configured: 'Настройка присутствует.',
        invalid: 'Сохраненная настройка недействительна.',
        verified: 'Проверка сертификата HTTPS включена.',
        plaintext: 'Шлюз использует незашифрованный HTTP.',
        verification_disabled: 'Проверка сертификата HTTPS отключена.',
        optional:
          'Сервисный токен не задан; это допустимо только если шлюз его не требует.',
        recorded: 'Операция IDC была зарегистрирована.',
      },
    },
    diagnostics: {
      copy: 'Копировать диагностику',
      copied: 'Диагностика скопирована',
      copyError: 'Не удалось скопировать диагностику',
    },
    configured: 'Шлюз настроен',
    notConfigured: 'Шлюз не настроен',
    refresh: 'Обновить',
    loading: 'Загрузка...',
    loadError: 'Не удалось загрузить настройки IDC-запросов',
    retry: 'Повторить',
    gateway: 'Шлюз',
    ...
    seconds: 'секунд',
    protection: 'Защита от злоупотреблений',
    requestsPerMinute: 'Запросов на участника в минуту',
    bindAttemptsPer10Minutes: 'Попыток привязки на участника за 10 минут',
    security: 'Безопасность',
    serviceToken: 'Сервисный токен',
    tokenConfigured: 'Настроен',
    tokenNotConfigured: 'Не настроен',
    tokenConfiguredPlaceholder:
      'Оставьте пустым, чтобы сохранить текущий токен',
    tokenPlaceholder: 'Введите сервисный токен',
    clearToken: 'Удалить токен',
    keepToken: 'Сохранить токен',
    tokenPendingClear: 'Текущий сервисный токен будет удалён при сохранении.',
    verifyTls: 'Проверять сертификат TLS',
    tlsDisabled: 'Проверка сертификата TLS отключена.',
    save: 'Сохранить',
    saving: 'Сохранение...',
    saveSuccess: 'Настройки IDC-запросов сохранены',
    ...
    callback: {
      title: 'Callback QQ Official',
      refresh: 'Обновить состояние callback',
      loading: 'Загрузка состояния callback QQ...',
      loadError: 'Не удалось загрузить состояние callback QQ',
      url: 'URL callback',
      copy: 'Копировать URL callback',
      copySuccess: 'URL callback скопирован',
      copyError: 'Не удалось скопировать URL callback',
      configuredUrl: 'Настроенный публичный URL',
      configuredBots: 'Настроенные боты QQ',
      activeWebhooks: 'Активные Webhook',
      bots: 'Боты QQ',
      empty: 'Боты QQ Official не настроены',
      unnamedBot: 'Бот QQ без имени',
      appId: 'ID приложения',
      enabled: 'Включён',
      disabled: 'Отключён',
      ...
      status: {
        ...
        disabled: 'Бот QQ отключён',
        websocket_mode: 'Режим WebSocket',
        conflict: 'Конфликт App ID',
      },
      mode: {
        webhook: 'Webhook',
        websocket: 'WebSocket',
    ...
    bindings: {
      ...
      loadError: 'Не удалось загрузить привязки групп IDC',
      empty: 'Привязанных групп пока нет',
      generatedAt: 'Обновлено {{time}} · показано {{count}} из {{total}}',
      boundAt: 'Время привязки',
      customer: 'Клиент',
      group: 'Группа QQ',
      boundBy: 'Кто привязал',
      unnamed: 'Клиент без имени',
    },
    audit: {
      refresh: 'Обновить операции',
      loading: 'Загрузка недавних операций...',
      loadError: 'Не удалось загрузить недавние операции IDC',
      empty: 'Операции IDC пока не записаны',
      generatedAt: 'Обновлено {{time}} · записей: {{count}}',
      time: 'Время',
      command: 'Команда',
      result: 'Результат',
      identity: 'Идентификатор QQ',
      member: 'Клиент',
      duration: 'Время',
      groupShort: 'Группа',
      ...
      outcomes: {
        success: 'Успешно',
        denied: 'Отклонено',
        rate_limited: 'Ограничено',
        gateway_error: 'Ошибка шлюза',
        internal_error: 'Внутренняя ошибка',
      },
      reasons: {
        bound: 'Привязка создана',
        unbound: 'Привязка удалена',
        queried: 'Запрос выполнен',
        not_bound: 'Группа не привязана',
        binder_required: 'Нужны права владельца привязки',
        already_bound: 'Уже привязано',
        binding_conflict: 'Привязан другой клиент',
        rate_limit: 'Достигнут лимит запросов',
        gateway_error: 'Запрос к шлюзу завершился ошибкой',
        internal_error: 'Ошибка обработки',
      },
    },
  },
  storageAnalysis: {
