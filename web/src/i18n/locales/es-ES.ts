const esES = {
  ...
  version: {
    ...
    updateCenter: 'Actualización de software',
    manageUpdates: 'Gestionar actualizaciones',
    ...
    deploying: 'Instalando actualización...',
    ...
    automaticUnavailable:
      'Las actualizaciones automáticas no están habilitadas en este servidor.',
    installUpdate: 'Actualizar ahora',
    reload: 'Recargar',
    confirmTitle: '¿Instalar la actualización?',
    confirmDescription:
      'El servicio se reiniciará y el panel no estará disponible brevemente.',
    updateQueued: 'Solicitud de actualización enviada',
  },
  account: {
  ...
  idcQuery: {
    ...
    tabs: {
      readiness: 'Resumen',
      configuration: 'Configuración',
      callback: 'Callback de QQ',
      bindings: 'Grupos vinculados',
      audit: 'Actividad reciente',
    },
    readiness: {
      title: 'Preparación para producción',
      refresh: 'Actualizar preparación',
      loading: 'Comprobando la preparación para producción...',
      loadError: 'No se pudo cargar la preparación para producción',
      generatedAt: 'Comprobado el',
      lastQQEvent: 'Último evento de QQ',
      lastIDCOperation: 'Última operación IDC',
      never: 'Aún no observado',
      overall: {
        ready: 'Listo',
      ...
      checks: {
        qq_bot: 'Bot oficial de QQ',
        qq_callback: 'Transporte de eventos QQ',
        qq_activity: 'Actividad de eventos QQ',
        plugin_runtime: 'Runtime de plugins',
        idc_plugin: 'Plugin de consulta IDC',
        gateway_config: 'Pasarela de consultas',
        gateway_tls: 'Seguridad de transporte de la pasarela',
        gateway_auth: 'Token de servicio de la pasarela',
        idc_activity: 'Actividad de operaciones IDC',
      },
      details: {
        unavailable: 'El estado no está disponible temporalmente.',
        enabled: 'Hay un bot oficial de QQ habilitado y en ejecución.',
        not_configured: 'Falta una configuración obligatoria.',
        disabled: 'El componente está deshabilitado.',
        ready: 'El transporte de eventos Webhook está listo.',
        websocket_mode: 'El bot usa WebSocket en lugar de la URL de callback.',
        conflict:
          'Los bots Webhook habilitados tienen App ID ausentes o duplicados.',
        received: 'Se recibió un evento QQ con firma verificada.',
        none: 'Aún no se ha observado actividad real.',
        connected: 'El runtime respondió a la comprobación de salud.',
        disconnected: 'El runtime no respondió a la comprobación de salud.',
        not_loaded: 'El plugin de consulta IDC no está cargado.',
        initialized: 'El plugin de consulta IDC se inicializó correctamente.',
        not_initialized:
          'El plugin de consulta IDC aún no terminó de inicializarse.',
        configured: 'La configuración está presente.',
        invalid: 'La configuración guardada no es válida.',
        verified: 'La verificación del certificado HTTPS está habilitada.',
        plaintext: 'La pasarela usa HTTP sin cifrar.',
        verification_disabled:
          'La verificación del certificado HTTPS está deshabilitada.',
        optional:
          'No hay token de servicio; solo es válido si la pasarela no lo exige.',
    ...
    refresh: 'Actualizar',
    loading: 'Cargando...',
    loadError: 'No se pudo cargar la configuración de consultas IDC',
    retry: 'Reintentar',
    gateway: 'Pasarela',
    ...
    timeout: 'Tiempo de espera',
    seconds: 'segundos',
    protection: 'Protección contra abuso',
    requestsPerMinute: 'Consultas por miembro / minuto',
    bindAttemptsPer10Minutes:
      'Intentos de vinculación por miembro / 10 minutos',
    security: 'Seguridad',
    serviceToken: 'Token de servicio',
    tokenConfigured: 'Configurado',
    tokenNotConfigured: 'Sin configurar',
    tokenConfiguredPlaceholder: 'Déjalo vacío para conservar el token actual',
    tokenPlaceholder: 'Introduce un token de servicio',
    clearToken: 'Borrar token',
    keepToken: 'Conservar token',
    tokenPendingClear: 'El token de servicio actual se borrará al guardar.',
    verifyTls: 'Verificar certificado TLS',
    tlsDisabled: 'La verificación del certificado TLS está desactivada.',
    save: 'Guardar',
    saving: 'Guardando...',
    saveSuccess: 'Configuración de consultas IDC guardada',
    ...
    callback: {
      title: 'Callback oficial de QQ',
      refresh: 'Actualizar estado del callback',
      loading: 'Cargando estado del callback de QQ...',
      loadError: 'No se pudo cargar el estado del callback de QQ',
      url: 'URL del callback',
      copy: 'Copiar URL del callback',
      copySuccess: 'URL del callback copiada',
      copyError: 'No se pudo copiar la URL del callback',
      configuredUrl: 'URL pública configurada',
      configuredBots: 'Bots de QQ configurados',
      activeWebhooks: 'Webhooks activos',
      bots: 'Bots de QQ',
      empty: 'No hay bots oficiales de QQ configurados',
      unnamedBot: 'Bot de QQ sin nombre',
      ...
      status: {
        ...
        disabled: 'Bot de QQ desactivado',
        websocket_mode: 'Modo WebSocket',
        conflict: 'Conflicto de App ID',
      },
      mode: {
        webhook: 'Webhook',
        websocket: 'WebSocket',
    ...
    audit: {
      ...
      loadError: 'No se pudo cargar la actividad reciente de IDC',
      empty: 'Aún no hay operaciones IDC registradas',
      generatedAt: 'Actualizado {{time}} · {{count}} registros',
      time: 'Hora',
      command: 'Comando',
      result: 'Resultado',
      identity: 'Identidad QQ',
      member: 'Miembro',
      duration: 'Duración',
      groupShort: 'Grupo',
      userShort: 'Usuario',
      ...
      reasons: {
        bound: 'Vinculación creada',
        unbound: 'Vinculación eliminada',
        queried: 'Consulta completada',
        not_bound: 'Grupo no vinculado',
        binder_required: 'Se requiere permiso del vinculador',
        already_bound: 'Ya está vinculado',
        binding_conflict: 'Vinculado a otro miembro',
        rate_limit: 'Límite de solicitudes alcanzado',
        gateway_error: 'Falló la solicitud a la pasarela',
        internal_error: 'Falló el procesamiento',
      },
    },
  },
  storageAnalysis: {
