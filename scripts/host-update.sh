...
load_deployment_settings() {
  ...
  export_deployment_setting "LANBOT_AUTO_BACKUP_BEFORE_UPDATE" "LANBOT_AUTO_BACKUP_BEFORE_UPDATE"
  export_deployment_setting "LANBOT_BACKUP_KEEP" "LANBOT_BACKUP_KEEP"
  export_deployment_setting "LANBOT_BACKUP_DIR" "LANBOT_BACKUP_DIR"
